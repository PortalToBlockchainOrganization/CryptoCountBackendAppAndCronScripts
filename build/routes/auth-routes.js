...
router.post('/payment', async (req, res) => {
    ...
    try {
      ...
      const amount = 100; // This would be the amount you want to charge in cents
      const currency = 'usd'; // This would be the currency you want to charge in
  
      await stripe.charges.create({
        amount,
        currency,
        customer: customer.id,
        description: 'Payment for service', // This is a description of the payment
      });
  
      res.send({ message: 'Payment succeeded!' });
    } catch (error) {
      console.error(error);
...
//     try {
//         console.log(req.body)
//       const { number, name, exp_month, exp_year, cvc, amount } = req.body;
//       console.log(number)
...
//       // Payment successful, send a response back to the client
//       res.json({ success: true });
//     } catch (err) {
//       // Payment failed, send an error response back to the client
