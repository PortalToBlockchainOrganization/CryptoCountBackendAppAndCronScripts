...
class TezosSet {
    ...
    //             this.aggregates()
    //         }).then(() => {
    //             console.log("made it the point of sale stuff")
    //             return this.pointOfSaleCosts()
    ...
    pointOfSaleCosts = async () => {
        ...
        console.log(this.pointOfSaleAggValue)
        ...
        console.log(this.netDiffSupplyDepletion)
        console.log('ending')
        return
